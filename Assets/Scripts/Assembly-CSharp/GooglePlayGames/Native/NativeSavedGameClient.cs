...
namespace GooglePlayGames.Native
{
	internal class NativeSavedGameClient : ISavedGameClient
	{
		...
		{
			Types.SnapshotConflictPolicy conflictPolicy = resolutionStrategy switch
			{
				ConflictResolutionStrategy.UseLastKnownGood => Types.SnapshotConflictPolicy.LAST_KNOWN_GOOD, 
				ConflictResolutionStrategy.UseMostRecentlySaved => Types.SnapshotConflictPolicy.MOST_RECENTLY_MODIFIED, 
				ConflictResolutionStrategy.UseLongestPlaytime => Types.SnapshotConflictPolicy.LONGEST_PLAYTIME, 
				ConflictResolutionStrategy.UseManual => Types.SnapshotConflictPolicy.MANUAL, 
				_ => Types.SnapshotConflictPolicy.MOST_RECENTLY_MODIFIED, 
			};
