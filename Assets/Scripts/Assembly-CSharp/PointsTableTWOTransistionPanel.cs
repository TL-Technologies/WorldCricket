...
public class PointsTableTWOTransistionPanel : Singleton<PointsTableTWOTransistionPanel>
{
	...
	public void PanelTransistion()
	{
		...
		s.Insert(0.52f, TeamsPanelImage[8].transform.DOScale(new Vector3(1f, 1f, 1f), 0.24f));
		s.Insert(0.56f, TeamsPanelImage[9].transform.DOScale(new Vector3(1f, 1f, 1f), 0.24f));
	}
