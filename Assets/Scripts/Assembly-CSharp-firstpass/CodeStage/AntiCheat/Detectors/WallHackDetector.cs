			...
			if (base.enabled && base.gameObject.activeSelf)
			{
				...
				if (checkWireframe && wfCamera == null)
				{
					...
					else
					{
						...
						{
							shaderTexture = new Texture2D(4, 4, TextureFormat.RGB24, mipChain: false, linear: true);
						...
						{
							renderTexture = new RenderTexture(4, 4, 24, RenderTextureFormat.ARGB32, RenderTextureReadWrite.sRGB);
						...
						{
							targetTexture = new Texture2D(4, 4, TextureFormat.RGB24, mipChain: false, linear: true);
